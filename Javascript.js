...
function renderRestaurants(restaurantsList) {
	...
	restaurantsList.forEach((restaurant) => {
		...
		restaurantDiv.innerHTML = `
            ...
            <button class="descript-btn">Détails</button>
...
// ---------------------------
/* écouteur d'évenement pour le bouton détails */
const descriptBtn = document.querySelector(".descript-btn");
const descriptifContent = document.querySelector(".descriptif-content");
...
if(descriptBtn){
	...
	descriptBtn.addEventListener("click", (event) => {
	if (!dropdown.contains(event.target)) {
		dropdown.classList.remove("show");
	}
});
